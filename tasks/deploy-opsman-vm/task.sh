...
EOF
  ...
  old_opsman_path="$(govc find "${GOVC_RESOURCE_POOL}" -name OpsManager*)"
  echo "resourse pool ${GOVC_RESOURCE_POOL}" 
  echo "old opsman $old_opsman_path"
  govc device.disconnect -vm.ipath="${old_opsman_path}" ethernet-1
